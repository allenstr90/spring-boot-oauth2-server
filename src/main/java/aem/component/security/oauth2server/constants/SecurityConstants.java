package aem.component.security.oauth2server.constants;

public class SecurityConstants {
    public static final String CLIENT_ID = "oauth2";
    public static final String SECRET = "oauth2secret";
    public static final String SIGQUO_RESOURCE_ID = "siresId";
    public static final String SIGQUO_BASE_RESOURCE_ID = "siresbaseId";
